...
public class JxOrderServiceImpl extends GenericManagerImpl<JxOrder, Long>
	...
	public Map<String, Object> finTime(String s1) {
		String sql = "select ord_addtime from jx_order where ord_managerno = '"
				+ s1
				+ "' and ord_status IN(1,3,4,5) ORDER BY ord_addtime ASC LIMIT 1";
		return jdbcTemplate.queryForMap(sql);
	}
	...
	// 用户总收入2018-04-22
	@Override
	public Float selectTotalUserRevenue(Object username) {
		String sql = "SELECT SUM(ord_price) from jx_order where ord_managerno = '"
	...
	// 总押金
	@Override
	public Float totalDeposit(Object username) {
		String sql = "SELECT SUM(ord_pledge) from jx_order where ord_managerno = '"
				+ username + "' and ord_status IN (1,3,4,5)";
		return jdbcTemplate.queryForObject(sql, Float.class);
	}
	...
	// 可提现额度、
	@Override
	public Float selectTxZong(Object username, String time, String last_add_time) {
		String sql = "SELECT SUM(ord_price) from jx_order where ord_managerno = '"
				+ username
				+ "' and ord_addtime <= '"
				+ time
	...
	@Override
	public Float selecttxYaJin(Object username, String time,
			String last_add_time) {
		String sql = "SELECT SUM(ord_pledge) from jx_order where ord_managerno = '"
				+ username
				+ "' and ord_addtime <= '"
	...
	// 用户销售台数
	@Override
	public int findWallNumberNew(Object username, String time,
			String last_add_time) {
		String sql = "SELECT count(*) from jx_order where ord_managerno = '"
				+ username + "' and pro_id = 1 and ord_addtime <= '" + time
				+ "' and ord_addtime > '" + last_add_time
	...
	@Override
	public int findVerticalNumberNew(Object username, String time,
			String last_add_time) {
		String sql = "SELECT count(*) from jx_order where ord_managerno = '"
				+ username + "' and pro_id = 2 and ord_addtime <= '" + time
				+ "' and ord_addtime > '" + last_add_time
	...
	@Override
	public int findDesktopNumberNew(Object username, String time,
			String last_add_time) {
		String sql = "SELECT count(*) from jx_order where ord_managerno = '"
				+ username + "' and pro_id = 3 and ord_addtime <= '" + time
				+ "' and ord_addtime > '" + last_add_time
	...
	@Override
	public int findWallRenewNumberNew(Object username, String time,
			String last_add_time) {
		String sql = "SELECT count(*) from jx_order where ord_managerno = '"
				+ username + "' and pro_id = 1 and ord_addtime <= '" + time
				+ "' and ord_addtime > '" + last_add_time
	...
	@Override
	public int findVerticalRenewNumberNew(Object username, String time,
			String last_add_time) {
		String sql = "SELECT count(*) from jx_order where ord_managerno = '"
				+ username + "' and pro_id = 2 and ord_addtime <= '" + time
				+ "' and ord_addtime > '" + last_add_time
	...
	@Override
	public int findDesktopRenewNumberNew(Object username, String time,
			String last_add_time) {
		String sql = "SELECT count(*) from jx_order where ord_managerno = '"
				+ username + "' and pro_id = 3 and ord_addtime <= '" + time
				+ "' and ord_addtime > '" + last_add_time
	...
	// 单个获取提现金额
	@Override
	public Float selectTxFwf(Object username, String time,String last_add_time) {
		String sql = "SELECT SUM(ord_price) from jx_order where ord_managerno = '"
				+ username
				+ "' and ord_addtime <= '"
				+ time
	...
	@Override
	public Float selectTxFwfYaJin(Object username, String time,
			String last_add_time) {
		String sql = "SELECT SUM(ord_pledge) from jx_order where ord_managerno = '"
				+ username
				+ "' and ord_addtime <= '"
	...
	@Override
	public Float selectTxXuFei(Object username, String time,
			String last_add_time) {
		String sql = "SELECT SUM(ord_price) from jx_order where ord_managerno = '"
				+ username
				+ "' and ord_addtime <= '"
	...
	@Override
	public Float selectTxXuFeiYaJin(Object username, String time,
			String last_add_time) {
		String sql = "SELECT SUM(ord_pledge) from jx_order where ord_managerno = '"
				+ username
				+ "' and ord_addtime <= '"
	...
	public int selectNumberOfInstalledIsers(String username) {
		String sql = "SELECT count(*) from jx_order where ord_managerno = "+username+" and ord_status IN (1,3,4,5)";
		return jdbcTemplate.queryForInt(sql);
	}

	@Override
	public int selectNumberOfInstalledIsersThreeYears(String username) {
		String sql = "SELECT count(*) from jx_order where ord_managerno = "+username+ " and ord_status IN (1,3,4,5) and ord_multiple >= 3";
		return jdbcTemplate.queryForInt(sql);
	}
